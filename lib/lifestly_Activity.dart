...
class LifestyleActivity extends StatefulWidget {
  const LifestyleActivity({super.key});

  @override
  State<LifestyleActivity> createState() => _LifestyleActivityPageState();
}

class _LifestyleActivityPageState extends State<LifestyleActivity> {
                  ...
                  child: Column(
                    children: [
                      ...
                      ListView(
                        ...
                        children: const [
                          TaskCard(
                            iconPath: 'assets/images/stack-of-books.png',
                            label: 'Reed a book',
                          ),
                          TaskCard(
                            iconPath: 'assets/images/sleeping.png',
                            label: 'Sleep early',
                          ),
                          TaskCard(
                            iconPath: 'assets/images/peace-of-mind.png',
                            label: 'Mind clearing',
                          ),
                          TaskCard(
