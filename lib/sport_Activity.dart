...
class SportActivityPage extends StatefulWidget {
  const SportActivityPage({super.key});

  @override
  State<SportActivityPage> createState() => _SportActivityPageState();
}

class _SportActivityPageState extends State<SportActivityPage> {
                  ...
                  child: Column(
                    children: [
                      ...
                      ListView(
                        ...
                        children: const [
                          TaskCard(
                            iconPath: 'assets/images/cycling.png',
                            label: 'Cycling',
                          ),
                          TaskCard(
                          ...
                          TaskCard(
                            iconPath: 'assets/images/workout-machine.png',
                            label: 'Exercise',
                          ),
                          TaskCard(
                            iconPath: 'assets/images/walking.png',
                            label: 'Walk',
                          ),
                        ],
                      ),
